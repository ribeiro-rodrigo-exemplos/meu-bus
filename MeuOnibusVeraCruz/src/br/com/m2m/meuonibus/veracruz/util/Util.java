package br.com.m2m.meuonibus.veracruz.util;
...
public class Util {
	...
	public static ConfiguracaoWS carregarConfiguracaoWS(Context context) {
		...
		try {
			InputStream rawResourse = context.getResources().openRawResource(
					R.raw.webservicesconfig);
	...
	public static ConfiguracaoWS carregaConfCliente(Context context) {
		...
		try {
			...
			configuracaoWS.setIdCliente(Integer.valueOf(properties
					.getProperty("idCliente")));
